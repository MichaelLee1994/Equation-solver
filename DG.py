...
class DGSolution:
    def __init__(self, N, partitions, layers, equation):
        ...
        self.res_bd_pred, self.u_bd_pred = self.net_bd(self.x_mid_bd_tf)
    ...
    def net_bd(self, mid_bd):
        ...
        return boundary_residue, u_bd_pred
...
if __name__ == "__main__":
    working_dir = "./Test_Collection/MNN_DG_test/"
    ...
    model = DGSolution(N, pivot, hidden_layers)
